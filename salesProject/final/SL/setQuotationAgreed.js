...
import { FlatList,StyleSheet, Alert,ScrollView, Text, View, TextInput, TouchableOpacity } from 'react-native';
...
export default class EditRemarks extends Component {
  ...
  componentDidMount() {
    ...
    this.retrieve_QuoteAgreed();
  }

  retrieve_QuoteAgreed() {
            ...
            renderItem={({ item }) =>
              <View style={styles.RemarksC}>
                ...
                <View style={styles.inputR}>
                  <Text style={{ marginTop: 5 }}>RM</Text>
                  {item.Quote_Agreed != "" ?
                    <TextInput
                      defaultValue={item.Quote_Agreed}
                      autoFocus={true}
                      editable={true}
